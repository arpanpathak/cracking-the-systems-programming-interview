...
<p class="listing"><span class="listing-label">Listing 21.1</span> The complete module, with its tests. <code>src/problems/worker_pool.rs</code> &middot; <a href="https://github.com/arpanpathak/cracking-the-systems-programming-interview/blob/prep-v2/rust-interview-lab/src/problems/worker_pool.rs">read the file on GitHub</a></p>
