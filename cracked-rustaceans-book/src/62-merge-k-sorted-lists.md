...
<p class="listing"><span class="listing-label">Listing 62.1</span> The complete program, with its tests. <code>src/bin/merge_k_sorted_lists_divide.rs</code> &middot; <a href="https://github.com/arpanpathak/cracking-the-systems-programming-interview/blob/prep-v2/rust-interview-lab/src/bin/merge_k_sorted_lists_divide.rs">read the file on GitHub</a></p>
