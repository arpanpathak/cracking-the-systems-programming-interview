...
<p class="listing"><span class="listing-label">Listing 33.1</span> The complete program, with its tests. <code>src/bin/reverse_string.rs</code> &middot; <a href="https://github.com/arpanpathak/cracking-the-systems-programming-interview/blob/prep-v2/rust-interview-lab/src/bin/reverse_string.rs">read the file on GitHub</a></p>
