...
<p class="listing"><span class="listing-label">Listing 29.1</span> The complete program, with its tests. <code>src/bin/command_line_args.rs</code> &middot; <a href="https://github.com/arpanpathak/cracking-the-systems-programming-interview/blob/prep-v2/rust-interview-lab/src/bin/command_line_args.rs">read the file on GitHub</a></p>
