...
import (
	...
	"github.com/arpanpathak/gpu-cloud-operator/internal/controller"
)
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "gpu-cloud-operator.example.com",
	})
	if err != nil {
	...
	fmt.Println("manager stopped") // unreachable in normal Ctrl-C flow, present for clarity
}
